package com.wellingtoncerqueira.workshopmongo.config;
...
import com.wellingtoncerqueira.workshopmongo.dto.AuthorDTO;
import com.wellingtoncerqueira.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa Viagem mano!", sfd.parse("21/03/218"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Aproveite", sfd.parse("22/03/218"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", sfd.parse("23/03/218"), new AuthorDTO(alex));
